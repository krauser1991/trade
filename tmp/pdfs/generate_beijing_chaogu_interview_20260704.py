...
MD_PATH = ROOT / "interviews/2026-07-04-奎妮财经对话北京炒家交易心得总结.md"
PDF_PATH = ROOT / "output/pdf/2026-07-04-奎妮财经对话北京炒家交易心得总结.pdf"
...
def build_pdf():
    ...
    def flush_table():
        ...
        width = doc.width
        if col_count == 4:
            col_widths = [width * 0.17, width * 0.28, width * 0.27, width * 0.28]
        elif col_count == 3:
            col_widths = [width * 0.23, width * 0.34, width * 0.43]
        elif col_count == 2:
