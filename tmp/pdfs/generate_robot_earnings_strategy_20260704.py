...
MD_PATH = ROOT / "strategies/2026-07-04-7月机器人行情中报业绩筛选版.md"
PDF_PATH = ROOT / "output/pdf/2026-07-04-7月机器人行情中报业绩筛选版.pdf"
...
def build_pdf():
    ...
    styles.add(ParagraphStyle(
        name="SmallCN", fontName="CN", fontSize=7.4, leading=10.0,
    ...
    def flush_table():
        ...
        width = doc.width
        if col_count == 5:
            col_widths = [width * 0.13, width * 0.20, width * 0.24, width * 0.22, width * 0.21]
        elif col_count == 4:
            col_widths = [width * 0.14, width * 0.26, width * 0.30, width * 0.30]
        elif col_count == 3:
            col_widths = [width * 0.22, width * 0.32, width * 0.46]
        elif col_count == 2:
