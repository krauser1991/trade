...
MD_PATH = ROOT / "daily-reviews/2026-07-15-盘后复盘与2026-07-16操作指引.md"
PDF_PATH = ROOT / "output/pdf/2026-07-15-盘后复盘与2026-07-16操作指引.pdf"
...
def table_widths(col_count: int, width: float):
    if col_count == 9:
        return [width * x for x in [0.11, 0.10, 0.11, 0.08, 0.08, 0.12, 0.10, 0.09, 0.21]]
    if col_count == 8:
