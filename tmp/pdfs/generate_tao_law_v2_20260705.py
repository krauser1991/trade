...
MD_PATH = ROOT / "strategies/2026-07-05-韬定律V2观念与中报业绩A股映射.md"
PDF_PATH = ROOT / "output/pdf/2026-07-05-韬定律V2观念与中报业绩A股映射.pdf"
...
def build_styles():
    ...
    styles.add(ParagraphStyle(
        name="SmallCN", fontName="CN", fontSize=7.3, leading=9.8,
...
def build_pdf() -> None:
    ...
    def flush_table() -> None:
        ...
        width = doc.width
        if col_count == 5:
            col_widths = [width * 0.16, width * 0.20, width * 0.24, width * 0.23, width * 0.17]
        elif col_count == 4:
            col_widths = [width * 0.19, width * 0.27, width * 0.27, width * 0.27]
        elif col_count == 3:
            col_widths = [width * 0.24, width * 0.38, width * 0.38]
        elif col_count == 2:
