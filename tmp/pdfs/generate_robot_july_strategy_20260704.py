...
MD_PATH = ROOT / "strategies/2026-07-04-7月机器人行情可做性与资金炒作顺序.md"
PDF_PATH = ROOT / "output/pdf/2026-07-04-7月机器人行情可做性与资金炒作顺序.pdf"
...
def build_pdf():
    ...
    styles.add(ParagraphStyle(
        name="TitleCN", fontName="CN", fontSize=21, leading=28,
        alignment=TA_CENTER, textColor=colors.HexColor("#172033"),
        spaceAfter=13,
    ))
    styles.add(ParagraphStyle(
        name="H2CN", fontName="CN", fontSize=14.5, leading=20,
    ...
    styles.add(ParagraphStyle(
        name="SmallCN", fontName="CN", fontSize=7.5, leading=10.2,
    ...
    def flush_table():
        ...
        width = doc.width
        if col_count == 5:
            col_widths = [width * 0.15, width * 0.21, width * 0.24, width * 0.20, width * 0.20]
        elif col_count == 4:
            col_widths = [width * 0.16, width * 0.28, width * 0.30, width * 0.26]
        elif col_count == 3:
            col_widths = [width * 0.22, width * 0.31, width * 0.47]
        elif col_count == 2:
